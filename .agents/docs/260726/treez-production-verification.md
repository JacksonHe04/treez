...
- Vercel deployment：`dpl_7xujNdXreiayZZErwi9YuokCYVZB`
...
| 中文品牌与首页字形 | 通过 | 导航、metadata、页脚与文档统一使用“树脂”；生产登录态用户名及未登录态强调词均为衬线正体，`font-style=normal` |
...
- Vercel：从 deployment `dpl_7xujNdXreiayZZErwi9YuokCYVZB` 回滚至 `dpl_8ocdf5gkGeYVdn19NwRmLa5TKRMx`。
